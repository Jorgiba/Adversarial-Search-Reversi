...
player_random = Player(
    name='Random',
    strategy=RandomStrategy(verbose=3),
    delay=1,
)
...
from p2_1322_06_Ibarreta_Rocha import Solution2  # import your StudentHeuristic here
...
player_a, player_b = player_manual, my_player1
...
print("Tiempo de ejecucion: ", time1- time0)
